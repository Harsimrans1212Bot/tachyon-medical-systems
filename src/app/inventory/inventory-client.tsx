...
const categories = [
  ...
  },
  {
    ...
    machines: [
      { name: "PET CT Scanner", slug: "pet-ct-scanner", specs: "Integrated PET/CT System" },
      { name: "GE Discovery PET/CT", slug: "ge-discovery-pet-ct", specs: "Advanced Molecular Imaging" },
      { name: "Siemens Biograph PET/CT", slug: "siemens-biograph-pet-ct", specs: "Premium PET/CT Platform" },
    ],
  },
  {
    name: "Cath Labs",
      ...
      <section className="pt-32 pb-16 hero-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="text-sm font-bold tracking-wider uppercase text-light-cyan">Our Inventory</span>
            <h1 className="text-4xl sm:text-5xl font-black text-white mt-3">Medical Equipment</h1>
            <p className="text-lg text-gray-300 mt-6 leading-relaxed">
              Explore our comprehensive inventory of premium medical imaging and diagnostic equipment from world-renowned manufacturers.
            </p>
          </div>
        </div>
      </section>
                      ...
                      {category.machines.map((machine) => (
                        ...
                        >
                          <div className="h-32 relative overflow-hidden rounded-lg mb-3">
                            <Image
                              src={categoryImages[category.name] || "/ct-scanner.jpg"}
                              alt={machine.name}
                              fill
