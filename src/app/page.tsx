    ...
    <>
      ...
      <section className="hero-gradient min-h-screen flex items-center relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          {/* MRI Bore Animation - Set A */}
          <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] rounded-full animate-[mri-spin-cw_10s_linear_infinite]" style={{ borderWidth: '16px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.08)', borderTopColor: 'rgba(100, 200, 255, 0.3)', borderRightColor: 'rgba(100, 200, 255, 0.15)' }} />
          <div className="absolute top-1/2 left-1/2 w-[370px] h-[370px] sm:w-[520px] sm:h-[520px] rounded-full animate-[mri-spin-ccw_7s_linear_infinite]" style={{ borderWidth: '12px', borderStyle: 'solid', borderColor: 'rgba(255, 140, 50, 0.06)', borderBottomColor: 'rgba(255, 140, 50, 0.25)', borderLeftColor: 'rgba(255, 140, 50, 0.12)' }} />
          <div className="absolute top-1/2 left-1/2 w-[260px] h-[260px] sm:w-[360px] sm:h-[360px] rounded-full animate-[mri-spin-cw_4s_linear_infinite]" style={{ borderWidth: '4px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.05)', borderTopColor: 'rgba(100, 200, 255, 0.2)' }} />
          {/* MRI Bore Animation - Set B (offset 180deg for seamless infinite look) */}
          <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] rounded-full animate-[mri-spin-cw_10s_linear_infinite]" style={{ borderWidth: '16px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.08)', borderTopColor: 'rgba(100, 200, 255, 0.3)', borderRightColor: 'rgba(100, 200, 255, 0.15)', animationDelay: '-5s' }} />
          <div className="absolute top-1/2 left-1/2 w-[370px] h-[370px] sm:w-[520px] sm:h-[520px] rounded-full animate-[mri-spin-ccw_7s_linear_infinite]" style={{ borderWidth: '12px', borderStyle: 'solid', borderColor: 'rgba(255, 140, 50, 0.06)', borderBottomColor: 'rgba(255, 140, 50, 0.25)', borderLeftColor: 'rgba(255, 140, 50, 0.12)', animationDelay: '-3.5s' }} />
          <div className="absolute top-1/2 left-1/2 w-[260px] h-[260px] sm:w-[360px] sm:h-[360px] rounded-full animate-[mri-spin-cw_4s_linear_infinite]" style={{ borderWidth: '4px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.05)', borderTopColor: 'rgba(100, 200, 255, 0.2)', animationDelay: '-2s' }} />
          {/* Floating shapes */}
