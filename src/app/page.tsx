    ...
    <>
      ...
      <section className="hero-gradient min-h-screen flex items-center relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          {/* MRI Bore Animation - Set A (thicker, tighter gaps, more faint) */}
          <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] rounded-full animate-[mri-spin-cw_10s_linear_infinite]" style={{ borderWidth: '28px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.04)', borderTopColor: 'rgba(100, 200, 255, 0.15)', borderRightColor: 'rgba(100, 200, 255, 0.08)' }} />
          <div className="absolute top-1/2 left-1/2 w-[410px] h-[410px] sm:w-[600px] sm:h-[600px] rounded-full animate-[mri-spin-ccw_7s_linear_infinite]" style={{ borderWidth: '24px', borderStyle: 'solid', borderColor: 'rgba(255, 140, 50, 0.03)', borderBottomColor: 'rgba(255, 140, 50, 0.13)', borderLeftColor: 'rgba(255, 140, 50, 0.07)' }} />
          <div className="absolute top-1/2 left-1/2 w-[330px] h-[330px] sm:w-[510px] sm:h-[510px] rounded-full animate-[mri-spin-cw_4s_linear_infinite]" style={{ borderWidth: '20px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.03)', borderTopColor: 'rgba(100, 200, 255, 0.12)' }} />
          {/* MRI Bore Animation - Set B (offset for seamless infinite look) */}
          <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] rounded-full animate-[mri-spin-cw_10s_linear_infinite]" style={{ borderWidth: '28px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.04)', borderTopColor: 'rgba(100, 200, 255, 0.15)', borderRightColor: 'rgba(100, 200, 255, 0.08)', animationDelay: '-5s' }} />
          <div className="absolute top-1/2 left-1/2 w-[410px] h-[410px] sm:w-[600px] sm:h-[600px] rounded-full animate-[mri-spin-ccw_7s_linear_infinite]" style={{ borderWidth: '24px', borderStyle: 'solid', borderColor: 'rgba(255, 140, 50, 0.03)', borderBottomColor: 'rgba(255, 140, 50, 0.13)', borderLeftColor: 'rgba(255, 140, 50, 0.07)', animationDelay: '-3.5s' }} />
          <div className="absolute top-1/2 left-1/2 w-[330px] h-[330px] sm:w-[510px] sm:h-[510px] rounded-full animate-[mri-spin-cw_4s_linear_infinite]" style={{ borderWidth: '20px', borderStyle: 'solid', borderColor: 'rgba(100, 200, 255, 0.03)', borderTopColor: 'rgba(100, 200, 255, 0.12)', animationDelay: '-2s' }} />
          {/* Floating shapes */}
