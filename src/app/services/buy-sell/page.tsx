  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="text-3xl font-black text-deep-blue mt-3">Looking to Buy?</h2>
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-10">
                {buyFeatures.map((f) => (
                  <div key={f.title} className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-deep-blue text-sm">{f.title}</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
              <h3 className="text-lg font-bold text-deep-blue mb-6">Tell Us What You Need</h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-100 order-2 lg:order-1">
              <h3 className="text-lg font-bold text-deep-blue mb-6">Describe Your Equipment</h3>
              <div className="space-y-4">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl font-black text-deep-blue mt-3">Looking to Sell?</h2>
              <p className="text-gray-500 mt-4 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-black text-deep-blue mb-4">Ready to Get Started?</h2>
