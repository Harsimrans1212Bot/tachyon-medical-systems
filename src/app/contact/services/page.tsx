      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">
                        <a href="mailto:admin@tachyonmedical.com" className="hover:text-orange transition-colors">admin@tachyonmedical.com</a>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div>
              <h2 className="text-2xl font-black text-deep-blue mb-8">Installation Services Inquiry</h2>
              <div className="bg-white rounded-2xl p-8 border border-gray-100">
                <form className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-semibold text-deep-blue mb-2">Name</label>
                      <input type="text" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none transition-all text-sm" placeholder="John Doe" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-deep-blue mb-2">Email</label>
                      <input type="email" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none transition-all text-sm" placeholder="john@hospital.com" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-deep-blue mb-2">Phone</label>
                    <input type="tel" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none transition-all text-sm" placeholder="+1 (555) 000-0000" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-deep-blue mb-2">Company/Facility Name</label>
                    <input type="text" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none transition-all text-sm" placeholder="Memorial Healthcare Center" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-deep-blue mb-2">Service Type</label>
