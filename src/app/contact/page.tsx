        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Link
              ...
              className="group bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-100 dark:border-white/10 hover:border-light-cyan/30 transition-all duration-300 card-hover"
            >
              ...
              <h3 className="text-2xl font-bold text-deep-blue dark:text-white mb-4 group-hover:text-light-cyan transition-colors duration-300">
                Inventory Inquiries
              </h3>
            ...
            <Link
              ...
              className="group bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-100 dark:border-white/10 hover:border-orange/30 transition-all duration-300 card-hover"
            >
              ...
              <h3 className="text-2xl font-bold text-deep-blue dark:text-white mb-4 group-hover:text-orange transition-colors duration-300">
          ...
          <div className="mt-16">
            <h3 className="text-2xl font-bold text-deep-blue dark:text-white mb-8 text-center">Our Offices</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-100 dark:border-white/10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h4 className="text-lg font-bold text-deep-blue dark:text-white">India Headquarters</h4>
                </div>
                <div className="space-y-4">
                  <div>
                    <p className="font-semibold text-deep-blue dark:text-white text-sm mb-1">Company Name</p>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">Tachyon Medical Systems Pvt. Ltd.</p>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-deep-blue dark:text-white text-sm">Website</p>
                      <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-100 dark:border-white/10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h4 className="text-lg font-bold text-deep-blue dark:text-white">US Office</h4>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <svg className="w-5 h-5 text-light-cyan mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Office Hours */}
            <div className="mt-8 bg-white dark:bg-white/5 rounded-2xl p-8 border border-gray-100 dark:border-white/10 text-center">
              <h4 className="text-lg font-bold text-deep-blue dark:text-white mb-4">Business Hours</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                <div>
                  <p className="font-semibold text-deep-blue dark:text-white mb-2">India Office (IST)</p>
                  <p className="text-gray-600 dark:text-gray-300">Monday - Saturday: 9:00 AM - 6:00 PM</p>
                  <p className="text-gray-600 dark:text-gray-300">Sunday: Closed</p>
                </div>
                <div>
                  <p className="font-semibold text-deep-blue dark:text-white mb-2">US Office (EST)</p>
