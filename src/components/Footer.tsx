      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="mb-4">
              <span className="text-2xl font-black tracking-wider">
                T<span className="text-orange">A</span>CHYON
              </span>
              <div className="text-[9px] font-semibold tracking-[0.2em] text-gray-400 -mt-1">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["CT Scanners", "MRI Systems", "PET-CT", "Cath Labs", "Mammography", "Sonography", "ECG Systems", "Monitors"].map((item) => (
                <li key={item}>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-bold tracking-wider uppercase mb-6 text-light-cyan">Contact</h3>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Tachyon Medical Systems Pvt. Ltd. All rights reserved.
          </p>
          <div className="flex gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-light-cyan/20 transition-colors"
              >
